			...
			<tr>
				<td width="25%"><table width="100%" border="0" cellspacing="0"
						...
						<tr>
							<td class="listtd"><img src="${pageContext.request.contextPath }/static/images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="${pageContext.request.contextPath }/view/user/modifyuserinfo">用户信息修改</a>
							</td>
						</tr>
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
						<a href="${pageContext.request.contextPath }/view/user/index">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a
							href="${pageContext.request.contextPath }/view/user/myAccount">&nbsp;我的帐户</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;订单查询
					</div>
					...
					<table cellspacing="0" class="infocontent">
						<tr>
							<td style="padding:20px"><p>欢迎${sessionScope.user.uname}光临商城！</p>
								<p>
								...
								<table width="100%" border="0" cellspacing="0" class="tableopen">
									...
									<tr>
										...
										<td class="tableopentd03"><a href="${pageContext.request.contextPath}/order/showOrdersInfo?oid=${o.oid}">查看</a>&nbsp;&nbsp;
											<a href="javascript:" onclick="deleteById('${o.oid}')">刪除</a>
										</td>
									</tr>
									</c:forEach>
								</table>
...
function deleteById(id){
	if (confirm("确认删除吗？")!= true)
		return;
	$.ajax({
		url:"${pageContext.request.contextPath}/order/deleteMyOrder/"+id,
		type:"post",
		data:{"_method":"DELETE"},
		async:false,
		success:function(d){
			if(d.flag=='1'){
				alert('删除成功');
				location.href="${pageContext.request.contextPath}/order/showMyorders?name="+${o.name};
			}
			else{
				alert('异常');
			}
