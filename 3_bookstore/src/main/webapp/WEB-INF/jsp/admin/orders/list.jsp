						...
						<c:forEach items="${list}" var="o">
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="10%">${o.name}</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="15%">${o.address}</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="10%">${o.telephone}</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center">
									${o.total}</td>
								<td width="8%" align="center">${o.name}</td>
								<td width="10%" align="center">
								${o.state==0?"未支付":"已支付" }</td>
								<td align="center" style="HEIGHT: 22px"><a
									href="${pageContext.request.contextPath}/admin/showOrdersInfo?oid=${o.oid}">
										<img
										src="${pageContext.request.contextPath}/static/images/admin/button_view.gif"
										border="0" style="CURSOR: hand"> </a></td>
								<td align="center" style="HEIGHT: 22px">
										<a
											href="href="javascript:" onclick="deleteById('${o.oid}')"">
											<img
...
function deleteById(id){
	if (confirm("确认删除吗？")!= true)
		return;
	$.ajax({
		url:"${pageContext.request.contextPath}/admin/deleteOrder/"+id,
		type:"post",
		data:{"_method":"DELETE"},
		async:false,
		success:function(d){
			if(d.flag=='1'){
				alert('删除成功');
				location.href="${pageContext.request.contextPath}/admin/showAllOrders";
			}
			else{
				alert('异常');
			}
