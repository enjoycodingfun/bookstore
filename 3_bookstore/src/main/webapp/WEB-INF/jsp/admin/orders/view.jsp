...
<body>
	<table cellSpacing="1" cellPadding="5" width="100%" align="center"
		...
		<tr>
			...
			<td class="ta_01" bgColor="#ffffff">${order.user.uname }</td>
		</tr>
				...
				<table cellspacing="0" cellpadding="1" rules="all"
					...
					<tr
						...
						<tr
							...
							<td align="center" width="7%">${order.product.pid}</td>
							<td width="8%" align="center"><img
								src="${pageContext.request.contextPath}/static/${order.product.pimage}"
								width="50" height="50"></td>

							<td align="center" width="18%">${order.product.pid }</td>
							<td align="center" width="10%">${order.product.pname }</td>
							<td align="center" width="10%">${order.product.marketPrice }</td>
							<td width="7%" align="center">${order.orderitem.count }</td>
							<td width="7%" align="center">${order.product.category.cname }</td>
							<td width="31%" align="center">${order.product.pdesc}</td>
						</tr>
